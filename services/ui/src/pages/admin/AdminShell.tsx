      ...
      <div className="h-14 bg-rose-700 text-white flex items-center justify-between px-6 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div className="leading-tight">
            ...
            <div className="text-xs text-white/80">Welcome, Admin User</div>
          </div>
        </div>
        <div className="flex items-center gap-3">
          <button className="rounded-xl bg-white/15 px-3 py-2 text-sm">User Mode</button>
          <button onClick={onLogout} className="rounded-xl bg-white/15 px-3 py-2 text-sm">
            Logout
          </button>
        </div>
      </div>
